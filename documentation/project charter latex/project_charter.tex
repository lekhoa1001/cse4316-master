...
\begin{figure}[h!]
	\centering
   	\includegraphics[width=0.50\textwidth]{images/smart_shutter_logo}
\end{figure}
\vspace{0.5 in}
...
\begin{versionhistory}
  	\vhEntry{0.1}{10.01.2018}{KH}{document creation}
  	\vhEntry{0.2}{10.05.2018}{KH|GH}{complete draft}
  	\vhEntry{0.3}{10.12.2018}{KH|GH}{release candidate 1}
  	\vhEntry{1.0}{10.20.2018}{KH|GH|CB|US}{official release}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{images/picture}
